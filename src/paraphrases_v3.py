...
(both the fixed base description AND the template/synonym augmentation
pool), used only to measure generalization at eval time.

Keys are composite labels matching dataset_v3's "<dataset>::<intent>" format.
"""
